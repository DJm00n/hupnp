...
QtSoapTypeFactory* QtSoapTypeFactory::s_instance = 0;
...
QtSoapTypeFactory &QtSoapTypeFactory::instance()
{
    ...
    s_instance = new QtSoapTypeFactory();
    return *s_instance;
}
...
QtSoapNamespaces* QtSoapNamespaces::s_instance = 0;
...
QtSoapNamespaces &QtSoapNamespaces::instance()
{
    ...
    s_instance = new QtSoapNamespaces();
    return *s_instance;
}
