...
#ifndef CONTROLPOINT_CONFIGURATION_H_
#define CONTROLPOINT_CONFIGURATION_H_
 ...
 *
 * \headerfile controlpoint_configuration.h HControlPointConfiguration
 *
...
#endif /* CONTROLPOINT_CONFIGURATION_H_ */
