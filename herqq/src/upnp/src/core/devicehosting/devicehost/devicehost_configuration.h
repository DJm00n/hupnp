...
#ifndef DEVICEHOST_CONFIGURATION_H_
#define DEVICEHOST_CONFIGURATION_H_
 ...
 *
 * \headerfile devicehost_configuration.h HDeviceConfiguration
 *
 ...
 *
 * \headerfile devicehost_configuration.h HDeviceHostConfiguration
 *
 * \ingroup devicehosting
 *
