...
#ifndef HUPNP_ACTIONARGUMENTS_H_
#define HUPNP_ACTIONARGUMENTS_H_
 ...
 *
 * \headerfile hactionarguments.h HActionInputArgument
 *
 * \ingroup devicemodel
 *
...
public:
     ...
     * \li the provided value can be converted to the right data type.
     *
 ...
 * \remark the class is not thread-safe.
 *
 * \headerfile hactionarguments.h HActionOutputArgument
 *
 * \ingroup devicemodel
 *
...
public:
    ...
    /*!
     * Indicates if the provided value can be set into this output argument
     * successfully.
     *
     * A value is considered \e valid, when:
     * \li the argument object is valid, i.e. isValid() returns true and
     ...
     * \param value specifies the value to be checked.
     *
     * \return \e true in case the provided value can be set into this output argument
     * successfully.
     */
    bool isValidValue(const QVariant& value);
};
 ...
 *
 * \headerfile hactionarguments.h HActionInputArguments
 *
 ...
 *
 * \headerfile hactionarguments.h HActionOutputArguments
 *
 * \remark this class is not thread-safe.
 *
 * \ingroup devicemodel
...
#endif /* HUPNP_ACTIONARGUMENTS_H_ */
