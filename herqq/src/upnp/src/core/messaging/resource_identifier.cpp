...
#include "../dataelements/resourcetype.h"
...
public:
        ...
        m_resourceType()
    {
        ...
        {
            throw HIllegalArgumentException(QObject::tr("Invalid resource: %1").arg(res));
        }
    }
        ...
        m_resourceType()
    {
        ...
        {
            throw HIllegalArgumentException(QObject::tr("Invalid resource type."));
        }
    }
    ...
    bool parse(const QString& nt)
    {
        ...
        else if (parsed[0] == "uuid")
        {
            ...
            if (uuid.isNull())
            {
                HLOG_WARN(QObject::tr("Invalid Device UUID"));
                return false;
            }
