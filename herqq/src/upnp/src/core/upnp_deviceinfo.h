 ...
 *
 * \headerfile upnp_deviceinfo.h HDeviceInfo
 *
 * \ingroup devicemodel
 *
...
friend H_UPNP_CORE_EXPORT bool operator==(const HDeviceInfo& obj1, const HDeviceInfo& obj2);

protected:

    HDeviceInfoPrivate* h_ptr;
    HDeviceInfo(HDeviceInfoPrivate& dd);
...
public:
     ...
     *
     * \throw Herqq::HIllegalArgumentException in case any of the provided
     * arguments does not meet the requirements.
     */
    HDeviceInfo(
    ...
    /*!
     * Indicates if the object is empty and thus "invalid" in a sense that it does
     * not contain the mandatory data of a device description.
     *
     * \retval true in case the object is empty.
