 ...
 *
 * \headerfile actionarguments.h HActionInputArgument
 *
 * \ingroup devicemodel
 *
 ...
 * \remark the class is not thread-safe.
 *
 * \headerfile actionarguments.h HActionOutputArgument
 *
 * \ingroup devicemodel
 *
 ...
 *
 * \headerfile actionarguments.h HActionInputArguments
 *
 ...
 *
 * \headerfile actionarguments.h HActionOutputArguments
 *
 * \remark this class is not thread-safe.
 *
 * \ingroup devicemodel
