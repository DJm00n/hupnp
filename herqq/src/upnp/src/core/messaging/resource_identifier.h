 ...
 *
 * \headerfile resource_identifier.h HResourceIdentifier
 *
...
public:
     ...
     *
     * \param resource specifies the contents of the object.
     *
     * \throws Herqq::HIllegalArgumentException in case the provided argument
     * does not contain a valid resource.
     */
     ...
     * Creates a new instance, if the specified argument is valid.
     *
     * \param resourceType specifies the contents of the object.
     *
     * \throws Herqq::HIllegalArgumentException in case the provided argument
     * does not contain a valid resource.
     */
     ...
     *
     * \param other specifies the other object from which the contents are copied.
     */
    HResourceIdentifier(const HResourceIdentifier& other);
     ...
     *
     * \param other specifies the other object from which the contents are assigned.
     * \return a reference to this.
     */
    HResourceIdentifier& operator=(const HResourceIdentifier& other);

    /*!
     * Returns the type of the object.
     *
     * \return the type of the object. If the object is invalid or "empty", the type
