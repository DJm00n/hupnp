...
#ifndef UPNP_DATATYPES_H_
#define UPNP_DATATYPES_H_
 ...
 *
 * \headerfile upnp_datatypes.h HUpnpDataTypes
 */
...
public:
     ...
     *
     * \return the UPnP data type enum value that matches the content of the specified string, if any.
     */
     ...
     * \param datatype specifies the data type to be checked.
     *
     * \return true if the specified data type is an integer.
     */
     ...
     * \param datatype specifies the data type to be checked.
     *
     * \return true if the specified data type is a rational number.
     */
