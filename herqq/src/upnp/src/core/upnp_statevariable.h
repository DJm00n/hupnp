...
#ifndef UPNP_STATEVARIABLE_H_
#define UPNP_STATEVARIABLE_H_
 ...
 *
 * \headerfile upnp_statevariable.h HStateVariable
 *
 * \ingroup devicemodel
 *
 * \sa HService
...
private:
    ...
    // \internal
    //
    // called during device model initialization
    //
    void setParentService(HService*);
