 ...
 *
 * \headerfile discovery_messages.h HResourceAvailable
 *
 * \ingroup ssdp
 *
...
public:
     ...
     *
     * \remark
     * \li if cacheControlMaxAge is smaller than 60, it it set to 60 or if it is
 ...
 * or you receive instances of this class from the Herqq::Upnp::HSsdp.
 *
 * \headerfile discovery_messages.h HResourceUnavailable
 *
 * \ingroup ssdp
 *
 * \remark the class provides an assignment operator, which is not thread-safe.
 ...
 * or you receive instances of this class from the Herqq::Upnp::HSsdp.
 *
 * \headerfile discovery_messages.h HResourceUpdate
 *
 * \ingroup ssdp
 *
 * \remark the class provides an assignment operator, which is not thread-safe.
 ...
 * or you receive instances of this class from the Herqq::Upnp::HSsdp.
 *
 * \headerfile discovery_messages.h HDiscoveryRequest
 *
 * \ingroup ssdp
 *
 * \remark the class provides an assignment operator, which is not thread-safe.
 ...
 * or you receive instances of this class from the Herqq::Upnp::HSsdp.
 *
 * \headerfile discovery_messages.h HDiscoveryResponse
 *
 * \ingroup ssdp
 *
 * \remark the class provides an assignment operator, which is not thread-safe.
