...
public:
    ...
    //
    // The following static methods specify return values that some
    // of the methods of the class may return.
    //
     ...
     */
    static qint32 UndefinedFailure()
    {
        return -1;
    }
...
public Q_SLOTS:
     ...
     * \sa quit()
     */
    qint32 init(QString* errorString = 0);
